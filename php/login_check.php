<?php 
  ...
  if(!$mb_id||!$mb_password) { //아이디나 패스워드를 입력하지 않았다면 아래 에러 출력하고 다시 로그인 페이지로 이동한다.
  ...
  // 조건문을 활용하여 변수에 담긴 id, pw값이 일치하는지 여부를 확인
  ...
  //아이디, 패스워드 체크가 잘이루어질 경우
  $_SESSION['ss_mb_id']=$mb_id; //아이디, 패스워드 정보를 가지고 세션생성
